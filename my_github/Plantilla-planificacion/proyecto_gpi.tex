...
\begin{consigna}{black}
La escala de prioridad se basa en un orden de importancia entre las mismas historias de usuario; el grado de prioridad se incrementa con el valor numérico.

La escala de ponderación se basa en una parametrización subjetiva elaborada entre los miembros del equipo y colaboradores donde se contempla el conocimiento que se tiene sobre la misma historia de usuario, la complejidad que representa, el volumen de trabajo que generará y la incertidumbre intrínseca de la misma. Dicha escala numérica en orden creciente de dificultad comprenderá tres valores 1, 3 y 7.
\begin{enumerate}
...
\begin{enumerate}
	...
	\item Ponderación: 3
\end{enumerate}
\item Como médico quiero una interfaz de usuario que permita exportar los datos medidos para que sean manipulables desde PC, Smartphone y/o tablet.
\begin{enumerate}
	\item Prioridad: 6
	\item Ponderación: 1
\end{enumerate}
